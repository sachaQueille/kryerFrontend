      ...
      <Center flex={1} px="3">
        <Center>
          <HStack
            ...
            onPress={() =>
              deliveryClick({ infoDelivery: e, infoExpeditor: expeditor })
            }
            style={{ marginLeft: "10%" }}
          >
            <Avatar
          ...
          <Box p="3">
            ...
            <Text>
              Nom : {info.infoDelivery.coordinates_recipient.lastName}
            </Text>
            <Text>
              Prenom : {info.infoDelivery.coordinates_recipient.firstName}
            </Text>
            <Text>Email : {info.infoDelivery.coordinates_recipient.email}</Text>
            <Text>
              Telephone : {info.infoDelivery.coordinates_recipient.phone}
            </Text>
          </Box>
        </Center>
        ...
        <Center>
          <Button.Group
            ...
            mx="12"
          >
            <Button style={{ width: "50%" }}>refuser</Button>

            <Button
              style={{ backgroundColor: "indigo", width: "50%" }}
              onPress={() =>
                props.navigation.navigate("TerminateMission", {
                  code: info.infoDelivery.verifCode,
                  price: info.infoDelivery.price,
                })
              }
            >
              accepter
