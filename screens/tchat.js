...
function Tchat(props){
  ...
  return (
    <NativeBaseProvider>
       <Image source={require(`../assets/fullInbox.png`)} style={{flex:1, justifyContent:'center', alignItems:'center',position:"absolute",marginTop:"122%",marginLeft:'35%',opacity:0.6}} width="60%" height="30%"/>
    <Box
      w={{
        base: "100%",
        md: "25%",
